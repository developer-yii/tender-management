...
<section class="mainSection">
    <div class="homeSectionPart">
        <div class="addCommonBtn newAdd">
            <a href="{{ route('document.index') }}" class="btn btnBack"><i class="bi bi-chevron-double-left"></i> siehe oben</a>
                    ...
                    <div class="profiledetails">
                        ...
                        <div class="btncenterSec">
                            <button class="btn btnCom" id="previewBtn">
                                <span><img src="{{$baseUrl}}images/eye-icon.png" alt="eye-icon"></span> BESCHEINIGUNG / UNTERLAGE VORSCHAU
                            </button>
                            <button class="btn btnCom" id="downloadPdf">
                                <span><img src="{{$baseUrl}}images/downloads-Folder.png" alt="downloads-Folder"></span> BESCHEINIGUNG / UNTERLAGE  HERUNTERLADEN
